...
class HandDetector():
    ...
    def checkGrabCnt(self, img, draw = True, debug = False):
        ...
        Checks for grabbing from both hands, returns the coordinates of the centers of 
        hands that are grabbing.

        Args:
            img: The image to process
        Returns:
            List: A list grabCnt that stores the coordinates of grabbing hands.
